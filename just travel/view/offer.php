                ...
                <table style="width:95%; margin:35px; margin-top: 10px;">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <fieldset style="margin-top:30px;">
                                    <h4> 10% Discount on Bkash </h4>
                                    <p>Located in Dhaka, 656 feet from High Commission of India in Dhaka, Shinepukur
                                        Suites provides accommodations with a restaurant, free private parking, a
                                        fitness center and a shared lounge.</p>
                                    <button onclick="../editpage/editevent.php">Edit</button> &nbsp;
                                    <button onclick="../editpage/deleteevent.php">Delete</button>
                            ...
                            <td>
                                <fieldset style="margin-top:30px;">
                                    <h4> 5% Discount on Bus Ticket with Nagat </h4>
                                    <p>Located in Dhaka, 656 feet from High Commission of India in Dhaka, Shinepukur
                                        Suites provides accommodations with a restaurant, free private parking, a
                                        fitness center and a shared lounge.</p>
                                    <button onclick="../editpage/editevent.php">Edit</button> &nbsp;
                        ...
                        <tr>
                            <td>
                                <fieldset style="margin-top:30px;">
                                    <h4> Free Break-Fast on Booking </h4>
                                    <p>Located in Dhaka, 656 feet from High Commission of India in Dhaka, Shinepukur
                                        Suites provides accommodations with a restaurant, free private parking, a
                                        fitness center and a shared lounge.</p>
                                    <button onclick="../editpage/editevent.php">Edit</button> &nbsp;
                            ...
                            <td>
                                <fieldset style="margin-top:30px;">
                                    <h4> Buy 2 get 1 Event ticket </h4>
                                    <p>Located in Dhaka, 656 feet from High Commission of India in Dhaka, Shinepukur
                                        Suites provides accommodations with a restaurant, free private parking, a
                                        fitness center and a shared lounge.</p>
                                    <button onclick="../editpage/editevent.php">Edit</button> &nbsp;
